...
import { Send, Settings, User, Cpu, AlertTriangle, Save, RefreshCw, Key, Database, ChevronDown, Globe, Cloud } from 'lucide-react';
...
const Intelligence = () => {
    ...
    const saveConfig = () => {
        const payload = { apiKeys, activeProvider, providerConfigs };
    ...
    const handleSend = async (e) => {
        ...
        try {
            ...
            const apiMessages = [
                { role: "system", content: "You are a senior teacher and experienced developer. You possess expert knowledge across all computer science and software engineering modules taught in a university or bootcamp setting, including full-stack development, AI, cybersecurity, systems administration, cloud architecture, IoT, web3, and more. You are highly practical, clear, encouraging, and adept at explaining complex technical concepts simply to students. You should guide students like a mentor." },
